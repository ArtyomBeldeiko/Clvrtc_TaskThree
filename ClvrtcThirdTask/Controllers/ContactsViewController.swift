...
class ContactsViewController: UIViewController {
    ...
    private lazy var longPressGesture = UILongPressGestureRecognizer(target: self,
            ...
            do {
                try self.contactStore.enumerateContacts(with: request) { contact, _ in
                    ...
                    if let image = profileImage, let number = number {
                        let contactItem = ContactData(givenName: name,
    ...
    private func showSettingsAlert() {
        let settingsAlert = UIAlertController(title: " ",
                                              message: "Please allow access to your contacts".localized(),
